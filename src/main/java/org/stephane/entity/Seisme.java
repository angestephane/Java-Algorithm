package org.stephane.entity;

import org.stephane.utility.Location;

public class Seisme implements Comparable<Seisme> {
    private Location myLocation;
    private String title;
    private double depth;
    private double magnitude;

    public Seisme(double lat, double lon, double mag,
                      String t, double d) {
    ...
    @Override
    public int compareTo(Seisme loc) {
